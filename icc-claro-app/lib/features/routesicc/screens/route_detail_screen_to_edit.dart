...
class RouteDetailScreenToEdit extends StatefulWidget {
...
class _RouteDetailScreenToEditState extends State<RouteDetailScreenToEdit> {
                  ...
                  return SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                        _spacing(),
                        CustomTextField(
                          controller: routeState.posLocationRouteIDController,
                          label: 'Route ID',
                          icon: Icons.numbers,
                          readOnly: true,
                        ),
                        _spacing(),
                        CustomTextField(
                          controller: routeState.posLocationIDController,
                          label: 'POS ID',
                          icon: Icons.numbers,
                          readOnly: true,
                        ),
                        ...
                        CustomTextField(
                          controller: routeState.statusController,
                          label: 'Estatus Recorrido',
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          ...
          if (routeStateHandler.validateForm()) {
            routeStateHandler.submitFormToEdit(
              context,
              route: widget.route,
              routeType: widget.routeType ?? 'openRoutes',
              roles: widget.roles ?? [],
