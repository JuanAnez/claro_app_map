...
import 'dart:io';
import 'dart:ui';
import 'package:icc_maps/data/entities/polygon_google_entity.dart';
import 'package:icc_maps/data/network/google_repository.dart';
...
class GoogleClient extends GoogleRepository {
  ...
  Future<MessageResponse> findGeoJson(
    ...
    try {
      ...
      final polygons = PolygonGoogleEntity.toPolygons(gzipData, color);
